...
class ZillizStore:
    ...
    def ensure_collection(self) -> None:
        ...
        schema.add_field(field_name="poi_address", datatype=DataType.VARCHAR, max_length=2048, nullable=True)
        schema.add_field(field_name="poi_city", datatype=DataType.VARCHAR, max_length=512, nullable=True)
        schema.add_field(field_name="summary", datatype=DataType.VARCHAR, max_length=8192, nullable=True)
        schema.add_field(field_name="evidence", datatype=DataType.VARCHAR, max_length=8192, nullable=True)
        ...
        schema.add_field(field_name="video_url", datatype=DataType.VARCHAR, max_length=2048, nullable=True)
        schema.add_field(field_name="video_id", datatype=DataType.VARCHAR, max_length=128, nullable=True)
                ...
                RetrievedReview.model_validate(
                    {
                        "poi": {
                            ...
                            "address": entity.get("poi_address"),
                            "city": entity.get("poi_city"),
                            "videoUrl": entity.get("video_url"),
                            "videoId": entity.get("video_id"),
    ...
    def _to_row(self, document: EmbeddedReviewDocument) -> dict[str, Any]:
        return {
            ...
            "poi_address": document.poi.address,
            "poi_city": document.poi.city,
            "summary": document.summary,
            "evidence": document.evidence,
            "search_text": document.searchText,
            "lat": document.poi.location.lat,
            "lng": document.poi.location.lng,
            "video_url": document.poi.videoUrl,
            "video_id": document.poi.videoId,

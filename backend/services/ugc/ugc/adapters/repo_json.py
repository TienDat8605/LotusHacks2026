...
class JsonJobRepository:
    ...
    def _job_to_dict(self, job: UGCJob) -> dict:
        ...
        return {
            ...
            "metadata": {
                ...
                "short_description": job.metadata.short_description,
                "atmosphere": job.metadata.atmosphere,
    ...
    def _dict_to_job(self, data: dict) -> UGCJob:
        ...
        metadata = VideoMetadata(
            ...
            short_description=data["metadata"].get("short_description"),
            atmosphere=data["metadata"].get("atmosphere"),
